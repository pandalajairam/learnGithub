...
public class NominationPage extends BasePage {
	...
	private static List<Map<String, String>> listOfRecords = ExcelReader.readExcelDataAsMap(System.getProperty("user.dir") + "\\testdata\\Nominees_List.xlsx");
	...
	public FairMarketValuePage nominationsPage() throws Throwable {
		...
		//	Added wait for IE Browser			
			...
			actionLib.ScrollToElementVisible(CommonVariables.CommonDriver.get().findElement(By.cssSelector("button[id='btnNominate_Text']")));
			...
			actionLib.ScrollToElementVisible(CommonVariables.CommonDriver.get().findElement(NominationPage_OR.IsGovernmentOfficialUnderLocalLawYES));
           actionLib.Click(CommonVariables.CommonDriver.get().findElement(NominationPage_OR.IsGovernmentOfficialUnderLocalLawYES), 10);


    		actionLib.Click(CommonVariables.CommonDriver.get()
					.findElement(NominationPage_OR.IsContractNegotiationOrPartYES), 2);
		...
		actionLib.Click(CommonVariables.CommonDriver.get().findElement(NominationPage_OR.btnSaveAndAdvanceToNextSection), 20);
