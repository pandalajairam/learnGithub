...
public class TestEngineWeb {
	...
	public void setWebDriverForLocal(String browser) throws IOException, InterruptedException {
		...
		case "firefox":
			...
			Thread.sleep(13000);
			System.out.println("In the case Firefox");
			this.WebDriver = new FirefoxDriver();
			DesiredCapabilities ffcapabilities = DesiredCapabilities.firefox();
			String ffurl = "http://172.33.18.11:4444/wd/hub";
			this.WebDriver = new RemoteWebDriver(new URL(ffurl), ffcapabilities);
			Thread.sleep(5000);
			break;

		/*
		 * Thread.sleep(13000); this.WebDriver = new FirefoxDriver();
		 * Thread.sleep(5000);
		 */
		...
		case "chrome":
			...
			/*
			 * System.out.println("In the case Chrome"); DesiredCapabilities
			 * capabilities = DesiredCapabilities.chrome();
			 * System.setProperty("webdriver.chrome.driver",
			 * "C:\\MummsBVTAutomation\\MummsFrameWork-04052016\\Drivers\\chromedriver.exe"
			...
			options.addArguments("test-type");
			capabilities.setCapability(ChromeOptions.CAPABILITY, options);
			// String chromeurl = "http://172.33.18.11:4444/wd/hub";
			DesiredCapabilities capabillities = DesiredCapabilities.chrome();
			this.WebDriver = new ChromeDriver(capabillities);
			Thread.sleep(10000);
