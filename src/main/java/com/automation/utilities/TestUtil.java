...
public class TestUtil {
	// true - Y
		...
		public static Xls_Reader xls = new Xls_Reader(System.getProperty("user.dir")+File.separator+"TestData"+File.separator+"LoginData.xlsx");
	synchronized public Hashtable<String, String> getData(String testCase, String sheetName){
		System.out.println("*************");
		System.out.println("*************"+System.getProperty("user.dir")+File.separator+"TestData"+File.separator+"LoginData.xlsx");
