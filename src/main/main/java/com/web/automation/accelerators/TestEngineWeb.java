...
public class TestEngineWeb {
		...
		try {	
			...
			try {
				...
				try {
					...
					ActionsLibrary.staticCopyFile(src, new File(System.getProperty("user.dir").replace("\\", "/")+"/logs/Failed-testng_xmls/test-failed_"+timestamp+"_"+System.nanoTime()+".xml"));
	...
	public void afterSuite() throws IOException {
		...
		if (isBrowserMobProxyReq() != null && isBrowserMobProxyReq().equalsIgnoreCase("yes")) {
			...
			if (ConfigManager.getProperties().getProperty("emailReport").toLowerCase().trim().contains("true") && BMP_Proxy_Controller.IsAnyAutomationAPIFailed){
				try{
	...
	public void beforeTest(ITestContext context) throws IOException {
		...
		try {
			...
			try {
				...
				System.out
				.println("Getting exception while setting platform and browser values: " + e.getMessage());
				CommonVariables.DeviceName.set(ConfigManager.getProperties().getProperty("deviceType"));
				CommonVariables.PlatformName.set(ConfigManager.getProperties().getProperty("platform"));
			}
			...
			if (Environment != null && browser != null
				...
				if (Environment.equalsIgnoreCase("Dev")) {
					...
					ConfigManager.getProperties().setProperty("url", "http://" + dev_url);			
					...
					ConfigManager.getProperties().setProperty("url", "http://" + qa_url);
					...
					ConfigManager.getProperties().setProperty("url", "http://" + stag_url);	
					...
					ConfigManager.getProperties().setProperty("url",
							"http://" + ConfigManager.getProperties().getProperty("prod_url"));
					ConfigManager.getProperties().setProperty("urlSuppressCredential",  "http://" +prod_url);
					...
					ConfigManager.getProperties().setProperty("url",
							"http://" + ConfigManager.getProperties().getProperty("preprod_url"));
					ConfigManager.getProperties().setProperty("urlSuppressCredential", "http://" + preprod_url);
				} else {
				}
			}
	...
	public void beforeMethod(Method method) throws IOException {
		...
		etest.assignAuthor("Developer : Gallop Automation Team");
