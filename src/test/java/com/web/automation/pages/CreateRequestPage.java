		...
		try {
			...
			if (!CommonVariables.CommonDriver.get()
				...
				actionLib.Click(CommonVariables.CommonDriver.get()
						.findElement(By.xpath("//div[@id='activity_overview']//div[@class='checkbox pull-left']")), 1);
			}
			...
			actionLib.Click(CommonVariables.CommonDriver.get()
					.findElement(By.xpath("//label[text()='Therapeutic Area:']/../..")), 1);
...
*/
		...
		actionLib.Click(CommonVariables.CommonDriver.get().findElement(By.xpath("//input[@name='saveAndNext']")),1);
		//	actionLib.Click(CommonVariables.CommonDriver.get().findElement(By.xpath("//input[@value='Save Section']")));
						
			//Thread.sleep(2000);
			
			actionLib.waitForInVisibilityOfElement(By.cssSelector("div[class*='blockUI blockMsg blockPage']>img"), "progress icon", 30);
			actionLib.Click(
					CommonVariables.CommonDriver.get()
							.findElement(By
									.xpath("//section[@id='sp_BNAActivityOverview']/..//div//button[contains(text(),'Edit Section')]")),1);
			//Thread.sleep(2000);
			actionLib.waitForInVisibilityOfElement(By.cssSelector("div[class*='blockUI blockMsg blockPage']>img"), "progress icon", 60);
