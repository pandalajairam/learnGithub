...
public class NominationPage extends BasePage {
	...
	public FairMarketValuePage nominationsPage() throws Throwable {
		...
		for (int i = 0; i < 5 && listOfRecords.size() > 0; i++) {
			...
			actionLib.WaitForElementVisible(NominationPage_OR.nomination_Name, 10);
			...
			actionLib.WaitForElementVisible(NominationPage_OR.nomination_nominees_section_button, 2);
